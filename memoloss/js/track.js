...
var campaignID = "69e1897d228cb565059010e3";
...
var initialSrc = "https://rt.bestlifetodaynow.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("rt.bestlifetodaynow.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://rt.bestlifetodaynow.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://rt.bestlifetodaynow.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
